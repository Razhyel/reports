...
--Exclui formas de pagamentos migradas
delete from ns.formaspagamentos where codigo not like '___';

-- atualiza grupos empresariais de acordo com os estabelecimentos

update ns.df_docfis set id_grupoempresarial = (select grupoempresarial from ns.gruposempresariais where codigo='002')
where id_grupoempresarial = '847f2c5b-c2e2-4672-abc3-2fc4323b45b6'
and id_estabelecimento in (select estabelecimento from ns.estabelecimentos where codigo in ('002', '003', '004', '006', '008', '013'));

update ns.df_docfis set id_grupoempresarial = (select grupoempresarial from ns.gruposempresariais where codigo='005')
where id_grupoempresarial = '847f2c5b-c2e2-4672-abc3-2fc4323b45b6'
and id_estabelecimento in (select estabelecimento from ns.estabelecimentos where codigo in ('005', '010', '012', '014', '015', '017'));

update ns.df_docfis set id_grupoempresarial = (select grupoempresarial from ns.gruposempresariais where codigo='011')
where id_grupoempresarial = '847f2c5b-c2e2-4672-abc3-2fc4323b45b6'
and id_estabelecimento in (select estabelecimento from ns.estabelecimentos where codigo in ('011'));

update ns.df_docfis set id_grupoempresarial = (select grupoempresarial from ns.gruposempresariais where codigo='007')
where id_grupoempresarial = '847f2c5b-c2e2-4672-abc3-2fc4323b45b6'
and id_estabelecimento in (select estabelecimento from ns.estabelecimentos where codigo in ('007', '009', '8888'));


--select id_estabelecimento, id_grupoempresarial,* from ns.df_docfis where id_grupoempresarial = (select grupoempresarial from ns.gruposempresariais where codigo='8888')
*/